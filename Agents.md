...
| Groom Lastname | Groom / Developer | Active |
| Bride Lastname | Bride / Content Editor | Active |
...
- Deployed to Firebase Hosting (https://your-wedding.web.app)
...
- Added walking pets animation (Dog Name the dog, Cat Name the cat)
...
- Updated wedding party (Sister Name -> Sister Married Name)
