...
const DEFAULT_SETTINGS = {
  ...
  timeline: [
    ...
    },
    {
      ...
      description: "Bride brought Cat Name, her 14-year reign of sass. Groom brought Dog Name, his naughty troublemaker. Together, they formed one adorably chaotic fur family.",
      icon: "🐾"
    },
    {
      year: "Proposal Date",
      title: "The Proposal",
      description: "Under the twinkling lights of the Sugar Land Tree Lighting Ceremony, surrounded by the magic of the holiday season, Groom got down on one knee. One question, one forever YES!",
      icon: "💍"
    },
    {
  ...
  pets: [
    {
      name: "Cat Name",
      type: "Black Cat • 14 years with Bride",
      personality: "The OG. Mysterious, sassy, and the true ruler of the household. She came with Bride and has graciously allowed Groom into her kingdom.",
      emoji: "🐈‍⬛",
      image: "/photos/little-baby.jpg"
    },
    {
      name: "Dog Name",
      type: "Grey Merle Labradoodle • 2.5 years with Groom",
      personality: "A naaaaaaasty, naughty girl. Fluffy chaos incarnate who has never met a rule she didn't want to break. Groom's troublemaking sidekick.",
      emoji: "🐕",
      image: "/photos/dog-name.jpg"
    }
  ],
  quotes: [
