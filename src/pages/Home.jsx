    ...
    <div className="flex items-end justify-center gap-2 pointer-events-none mt-2">
          ...
          <g fill="#1a1a1a">
            ...
            {catBlink ? (
              ...
              <>
                ...
                <circle cx="28" cy="20" r="2" fill="#eab308" />
      ...
      >
        <svg width="45" height="40" viewBox="0 0 70 50">
          ...
          {dogBlink ? (
            <>
              <path d="M29,22 Q32,21 35,22" stroke="#3b82f6" strokeWidth="1.5" fill="none" />
              <path d="M35,22 Q38,21 41,22" stroke="#3b82f6" strokeWidth="1.5" fill="none" />
            </>
          ) : (
            <>
              <circle cx="30" cy="22" r="2.5" fill="#3b82f6" />
              <circle cx="40" cy="22" r="2.5" fill="#3b82f6" />
...
function ElegantBorder() {
  return (
    <div className="absolute inset-0 pointer-events-none">
      {/* Single thin border line - very minimal */}
      <div className="absolute inset-[2px] md:inset-2 border border-accent-400/30" />
      {/* Corner flourishes - tiny on mobile */}
      {['top-0 left-0', 'top-0 right-0 rotate-90', 'bottom-0 right-0 rotate-180', 'bottom-0 left-0 -rotate-90'].map((pos, i) => (
        <svg key={i} className={`absolute ${pos} w-4 h-4 md:w-6 md:h-6 text-accent-400/30`} viewBox="0 0 50 50">
...
function OrnamentalDivider() {
  return (
    <div className="flex items-center justify-center gap-2 my-1 md:my-2">
      <div className="h-px w-12 md:w-20 bg-gradient-to-r from-transparent to-accent-400/60" />
      ...
      <div className="h-px w-12 md:w-20 bg-gradient-to-l from-transparent to-accent-400/60" />
    </div>
  )
}
...
function Home({ raveMode, theme = 'burgundy', font }) {
  ...
  return (
    <div
      className="h-[calc(100vh-48px)] md:h-[calc(100vh-56px)] w-screen overflow-hidden flex items-center justify-center"
      style={{ background: paperBackground[theme] }}
    >
      {/* Paper invitation card */}
      <div className="relative w-full h-full flex items-center justify-center">
        {/* Main content - edge to edge, no border */}
        <div
          className="text-center px-1 py-2 z-10 flex flex-col justify-center w-full"
          style={{ fontFamily: font }}
        >
          {/* Top flourish text */}
          <p
            className="uppercase tracking-[0.12em] md:tracking-[0.25em] text-[15px] md:text-lg mb-2 md:mb-3"
          ...
          <h1
            className={`text-7xl md:text-9xl font-light leading-none ${raveMode ? 'rave-spin' : ''}`}
          ...
          <p
            className="text-3xl md:text-5xl italic my-0.5 md:my-1"
            style={{ color: colors.accent }}
          >
            &amp;
          </p>
          ...
          <h1
            className={`text-7xl md:text-9xl font-light leading-none mb-2 md:mb-3 ${raveMode ? 'rave-spin' : ''}`}
            style={{ color: colors.primary }}
          >
            Bruce
          </h1>
          ...
          {/* Date */}
          <p
            className="text-2xl md:text-4xl mt-1 md:mt-2 tracking-wide font-light"
            style={{ color: colors.primary }}
          >
            {getWeddingDate()}
          </p>
          ...
          {/* Venue */}
          <p
            className="text-base md:text-xl mt-1 tracking-wider"
          ...
          <div className="mt-4 md:mt-5">
            <Link
              to="/rsvp"
              className="inline-block px-8 md:px-12 py-2 md:py-3 text-xs md:text-sm tracking-[0.2em] uppercase transition-all duration-300 border"
              style={{
          ...
          <div className="mt-2 md:mt-3">
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[10px] md:text-xs transition-colors hover:opacity-70"
              style={{ color: colors.accent }}
            >
