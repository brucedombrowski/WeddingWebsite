                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-pink-50 p-3 rounded-lg border border-pink-200">
                    ...
                    <input
                      ...
                      placeholder="What's Hilary's answer?"
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                    ...
                    <input
                      ...
                      placeholder="What's Bruce's answer?"
                ...
                >
                  ...
                  <div className="space-y-1 text-sm">
                    <p className="bg-pink-50 px-2 py-1 rounded text-pink-800">
                      <span className="font-medium">👰 Hilary:</span> {fact.hilary || '(not set)'}
                    </p>
                    <p className="bg-blue-50 px-2 py-1 rounded text-blue-800">
                      <span className="font-medium">🤵 Bruce:</span> {fact.bruce || '(not set)'}
                    </p>
                  </div>
                </div>
              )}
              ...
              {editingPet === index ? (
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Type (e.g., Black Cat • 14 years with Hilary)"
                    className="w-full px-3 py-2 border border-accent-200 rounded-lg"
                  />
                  <textarea
