...
function WeddingParty({ raveMode }) {
  ...
  const defaultParty = {
    bridesmaids: [
      { id: '1', name: "Maid of Honor Name", role: "Maid of Honor", bio: "", isHonor: true },
      { id: '2', name: "Ana Salas", role: "Bridesmaid", bio: "" },
      { id: '3', name: "Tracy", role: "Bridesmaid", bio: "" },
      { id: '4', name: "Sister Married Name", role: "Bridesmaid", bio: "" },
      { id: '5', name: "Junior Bridesmaid 1", role: "Junior Bridesmaid", bio: "Niece of Bride" },
      { id: '6', name: "Junior Bridesmaid 2", role: "Junior Bridesmaid", bio: "Groom's daughter" },
      { id: '7', name: "Flower Girl Name", role: "Flower Girl", bio: "Niece of Bride" },
    ],
    groomsmen: [
  ...
  ) || { name: "Maid of Honor Name", role: "Maid* of Honor", subRole: "(Matron)", isHonor: true }
